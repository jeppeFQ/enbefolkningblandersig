...
```{r fig-5-2, echo=FALSE, out.width= "70%", fig.cap="Beskæftigedes med dansk-dansk herkomst gennemsnitlige eksponering til indvandrere/efterkommere på deres arbejdsplads i 1996 (venstre) og 2019 (højre).", fig.topcaption=TRUE}

...
\urlstyle{same}
\hypersetup{
  pdftitle={En befolkning blander sig---Danskernes og indvandrernes kontakt i familier og på skoler og arbejdspladser},
...
\title{En befolkning blander sig---\emph{Danskernes og indvandrernes kontakt i familier og på skoler og arbejdspladser}}

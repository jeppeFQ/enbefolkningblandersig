...
\pagenumbering{roman}
\pagestyle{empty}  % Suppress page numbering initially
\AtBeginDocument{
      \addtocounter{page}{6}  % Skip 6 pages
      \pagestyle{plain}  % Start numbering from page 7

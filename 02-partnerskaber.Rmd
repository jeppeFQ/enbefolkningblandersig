...
```{r fig-2-1, echo=FALSE, out.width= "100%", fig.cap=" Partnerskaber med samme og forskelligt oprindelsesland. Opgjort i 1985 og 2020."}
...
```{r fig-2-2, echo=FALSE, out.width= "100%", fig.cap="Tværetniske partnerskab i 2020."}
